...
/* Fading animation keyframes-- stack overflw */
...
<div>
  ...
  <?php if ($mood_val !== null): ?>
    <!-- Show the transparent emoji face! -->
...
<div>
  ...
  <!-- Show fire icon and the streak count! -->
  <p style="font-size: 36px; margin: 10px 0;">🔥 <strong><?php echo $_SESSION['streak'] ?? 0; ?></strong></p>
